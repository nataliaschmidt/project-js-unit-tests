...
describe('10 - Implemente a função `createMenu`, bem como seus casos de teste', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof createMenu(meuRestaurante)['fetchMenu']).toEqual('function');
    ...
    objetoRetornado.order('chocolate');
    expect(objetoRetornado.order()).toEqual('Item indisponível');
    ...
    objetoRetornado.order('coxinha');
    expect(objetoRetornado.consumption).toEqual(['coxinha', 'cerveja', 'sanduiche', 'coxinha']);
